...
import { getPeticionCursosBlandos } from "../../dist/Capacitacion/getPeticiones";
...
function TablaHabilidadesBlandas() {
  const styles = useStyles();
  const [openModalCursoUpdtSoli, setOpenModalCursoUpdtSoli] = useState(false);
  const [loading, setLoading] = useState(true);
  const [selectedRow, setSelectedRow] = useState(null);
  const [dataCursosBlandos, setDataCursosBlandos] = useState([]);
  ...
  useEffect(() => {
    getPeticionCursosBlandos(setDataCursosBlandos, setLoading);
      ...
      <div className="mt-3">
        <MaterialTable
          ...
          options={{
            ...
            exportButton: true,
            exportAllData: true,
            exportFileName: "Tabla de habilidades blandas",
...
export default TablaHabilidadesBlandas;
