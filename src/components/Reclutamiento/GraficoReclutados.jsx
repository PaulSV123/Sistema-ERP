...
import {
  ...
  getPeticionListarPostulantesYear,
  getPeticionListarPostulantesYearnAndPlataforma,
...
const GraficoFiltroFecha = () => {
  ...
  useEffect(() => {
    ...
    setYear(yearActual);
    getPeticionListarPostulantesYear(yearActual).then((datos) => {
  ...
  const handleSubmitUpdate = async () => {
    setLoading(true);
    const datos = await getPeticionListarPostulantesYear(year);
    actualizarGrafico(datos);
    setLoading(false);
  };
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2">
        ...
        Cantidad de postulantes reclutados por año
        </h2>
...
const GraficoFiltroFechaPlataforma = () => {
  ...
  const loadDataInitial = async () => {
    ...
    const datosPlataforma =
      await getPeticionListarPostulantesYearnAndPlataforma(
        yearActual,
        IdfirstPlataforma
      );
    setYear(yearActual);
  ...
  const handleSubmitUpdate = async () => {
    setLoading(true);
    const datos = await getPeticionListarPostulantesYearnAndPlataforma(
      year,
      plataformaSelected
    );
    actualizarGrafico(datos);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2">
        <h2 className="text-center text-lg font-semibold col-span-2  text-black">
        Cantidad de postulantes reclutados por plataforma y año
        </h2>
...
export default GraficoReclutados;
