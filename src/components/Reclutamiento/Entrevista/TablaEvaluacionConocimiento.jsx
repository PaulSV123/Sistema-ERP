      ...
      <div className="flex justify-evenly items-center">
        <button
          ...
          onClick={async () => {
            ...
            setCamposCambiados([]);
            // setUpData([]);
            //optimizacion tabla connocimiento
            abrirCerrarModalConfirmar();
            let route = window.location;
            route['hash'] = '/reclutamiento/tabla-evaluacion-conocimiento'; 
    ...
    <div className="container mx-auto">
      <div className="main mt-3 relative h-full w-full">
        ...
        <ParametrosEvaluacion
          calificacion="Calificacion de la observación del conocimiento"
          califAprobado="Aprobado: 2"
          califAprobadoBajo="Aprobado bajo: 1"
          califDesaprobado="Desaprobado: 0"
          puntajeTotal="Puntaje total de la observación del conocimiento"
