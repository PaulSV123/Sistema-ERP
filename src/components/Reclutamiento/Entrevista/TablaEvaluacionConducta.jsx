...
const TablaEvaluacionConducta = () => {
  ...
  const columns = [
    ...
    {
      title: "ATENCIÓN A EXPLICACIONES",
      field: "Está atento/a a las explicaciones que se le da",
      lookup: calificacion,
      filtering: false,
    },
    {
      title: "COMPRENSIÓN DE INSTRUCCIONES",
      field: "Comprende las instrucciones de forma rápida",
      filtering: false,
      lookup: calificacion,
      // cellStyle: { whiteSpace: "nowrap" },
    },
    ...
    {
      title: "INTERES",
      field: "Muestra interés durante el desarrollo de las sesiones",
      lookup: calificacion,
      filtering: false,
    },
    {
    ...
    },
    {
      title: "DISTRACCIÓN",
      field:
        "NO Usa objetos distractores durante las sesiones (teléfono, MP4, tablet, etc)",
      lookup: calificacion,
      filtering: false,
    },
    {
  ...
  const options = {
    ...
    exportAllData: true,
    exportFileName: "Tabla de Evaluación Conducta",
  ...
  const dataPuntajePostulante = (newData) => {
    const Puntaje1 = Number(
      newData["Está atento/a a las explicaciones que se le da"]
    );
    const Puntaje2 = Number(
      newData["Comprende las instrucciones de forma rápida"]
    );
    const Puntaje3 = Number(
      newData["Pregunta ante la presencia de alguna dificultad"]
    );
    const Puntaje4 = Number(
      newData["Muestra interés durante el desarrollo de las sesiones"]
    );
